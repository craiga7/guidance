...
class trajPlotter:
    ''' 
        This class plots the time histories for the target and missile data.
    '''
    ...
    def __init__(self,N):
        ...
        self.handle = []
        self.handle.append(myPlot(self.ax, xlabel='x', ylabel='y'))# missile
        self.handle.append(myPlot(self.ax, xlabel='x', ylabel='y',title=self.N))# missile

    def update(self, xm, ym, xt, yt):
        '''
            Add to the time and data histories, and update the plots.
        '''
        # update the time history of all plot variables
        self.xm_history.append(xm)  # 
        self.ym_history.append(ym)  # 
        self.xt_history.append(xt)  # 
        self.yt_history.append(yt)  # 

        # update the plots with associated histories
        self.handle[0].update(self.xm_history, [self.ym_history])
        self.handle[1].update(self.xt_history, [self.yt_history])
